...
class GetURLHandler {
 public:
  ...
  static GetURLHandler* Create(pp::Instance* instance,
							   const std::string& url,
							   NaClHTTPCallback callback,
							   void *pUserData);
  // Initiates page (URL) download.
  void Start();

 private:
  GetURLHandler(pp::Instance* instance,const std::string& url,NaClHTTPCallback callback,void *pUserData);
  ~GetURLHandler();
